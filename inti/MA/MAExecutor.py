...
def MAExecutorJL(obj,file_name,collection_name,max_threads=None):
    ...
    r = Parallel(n_jobs=jobs,backend="multiprocessing", verbose=0)(delayed(obj.process_wrapper)(file_name,collection_name,chunkStart,chunkSize) for chunkStart,chunkSize in obj.chunkify(file_name))
