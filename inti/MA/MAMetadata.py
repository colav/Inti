...
MAColumnNames['mag']['Authors_indexes'] = [('AuthorId',1),('LastKnownAffiliationId',1)]
...
MAColumnNames['mag']['Affiliations_indexes'] = [('AffiliationId',1),('GridId',1)]
...
MAColumnNames['mag']['PaperAuthorAffiliations_indexes'] = [('PaperId',1),('AuthorId',1),('AffiliationId',1)] 
...
MAColumnNames['mag']['Papers_indexes'] = [('PaperId',1),('JournalId',1),('ConferenceSeriesId',1),('ConferenceInstanceId',1),('FamilyId',1),("Doi","text")]
...
MAColumnNames['mag']['PaperReferences_indexes'] = [('PaperId',1), ('PaperReferenceId',1)]
...
MAColumnNames['mag']['ConferenceInstances_indexes'] = [('ConferenceInstanceId',1),('ConferenceSeriesId',1)]
...
MAColumnNames['nlp']['PaperCitationContexts_indexes'] = [('PaperId',1),('PaperReferenceId',1)]
...
MAColumnNames['advanced']['EntityRelatedEntities_indexes'] = [('EntityId',1),('RelatedEntityId',1)]
MAColumnNames['advanced']['FieldOfStudyChildren'] = ['FieldOfStudyId','ChildFieldOfStudyId']
MAColumnNames['advanced']['FieldOfStudyChildren_indexes'] = [('FieldOfStudyId',1),('ChildFieldOfStudyId',1)]
MAColumnNames['advanced']['FieldOfStudyExtendedAttributes'] = ['FieldOfStudyId','AttributeType','AttributeValue']
MAColumnNames['advanced']['FieldOfStudyExtendedAttributes_indexes'] = [('FieldOfStudyId',1)]
...
MAColumnNames['advanced']['PaperFieldsOfStudy_indexes'] = [('PaperId',1),('FieldOfStudyId',1)]
MAColumnNames['advanced']['PaperRecommendations'] = ['PaperId','RecommendedPaperId','Score']
MAColumnNames['advanced']['PaperRecommendations_indexes'] = [('PaperId',1),('RecommendedPaperId',1)]
MAColumnNames['advanced']['RelatedFieldOfStudy'] = ['FieldOfStudyId1','Type1','FieldOfStudyId2','Type2','Rank']
MAColumnNames['advanced']['RelatedFieldOfStudy_indexes'] = [('FieldOfStudyId1',1),('FieldOfStudyId2',1)]
